...
function changeModel() {
	var changeModelName = document.getElementById("model-text");
	if (modelName === 'Model XYZ') {
		modelName = 'Model CPRG';
		changeModelName.innerHTML = modelName;
	} else {
		modelName = 'Model XYZ';
		changeModelName.innerHTML = modelName;
	}
...
function changeDuration() {
	var changeModelDuration = document.getElementById("duration-text");
	duration = prompt("Enter a new duration", "");
	changeModelDuration.innerHTML = duration;
	recalculate();
}
